#NEW in this version, crouching
#new canStand function to check if the player should be able to stand when the crouch button is released and will return a boolean value to represent this
import random
import pygame,sys
...
pygame.display.set_caption("Cake Knight testing")
...
level1 =  [ ['k',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','k'],#1
            ...
            ['k',' ',' ',' ',' ','i','h','k','i','i',' ',' ',' ','k','k','k',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','i','i','k'],#13
            ['k','i','i','i','i',' ','h',' ','k','k',' ',' ','i','k','k','k','i','i','i',' ',' ',' ',' ',' ',' ',' ',' ',' ','i','k',' ','k'],#14
            ['k',' ','k','k',' ',' ','h',' ',' ',' ',' ',' ','c',' ',' ',' ','e',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','i','k',' ',' ','k'],#15
            ['k',' ',' ',' ',' ',' ','h',' ',' ',' ',' ','i','i','i','i','i','i','i','i','i','i',' ',' ',' ','i','i','i','k',' ',' ',' ','k'],#16
            ['k','l','l','l','l','l','l','l','l','l','l','l','k','k','k','k','l','k','k','l','l','l','l','l','l','l','l','l','l','l','l','k'],#17
            ['k','.','.','.','.','k','.','.','.','k','.','.','.','.','k','k','.','.','k','.','k','.','.','.','.','.','.','k','.','.','.','k'],#18
            ['k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','.','.','.','k','k','k','k','k','k','k','k','k','k','k','k','k'],#19
            ['k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k','k']]#20
...
level2 =  [ ['k',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','k'],#1
            ['k',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','h',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','k'],#2
            ['k',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','h',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','k'],#3
            ['k',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','w','w','h','w','w','w',' ','w','w',' ',' ',' ',' ',' ',' ',' ',' ',' ','k'],#4
            ['k',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','h',' ','s','s',' ','s',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','k'],#5
            ['k',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','m',' ',' ',' ','h',' ','s','s',' ',' ',' ','e','c',' ',' ',' ',' ',' ',' ',' ','k'],#6
            ['k',' ',' ',' ',' ',' ','h',' ','m',' ',' ','i','i',' ',' ','h',' ',' ','s','s','s','s','s','s',' ',' ',' ',' ',' ',' ',' ','k'],#7 end procedure
            ['k',' ',' ',' ',' ',' ','h','i','i',' ',' ',' ','k',' ',' ','h',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','k'],#8
            ['k',' ',' ',' ',' ',' ','h',' ',' ',' ',' ',' ',' ',' ',' ','h',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','k'],#9
            ['k',' ',' ',' ','c',' ','h',' ',' ',' ',' ',' ',' ',' ',' ','h','m',' ',' ',' ',' ',' ',' ',' ',' ','i',' ','e',' ',' ',' ','k'],#10
            ['k',' ',' ',' ','w',' ','h',' ',' ',' ',' ',' ','c','e',' ','i','i','i',' ',' ',' ',' ','e',' ',' ',' ',' ','i',' ',' ',' ','k'],#11
            ['k','w','w','w',' ',' ','h','i',' ',' ',' ','i','i','i','i','k','k',' ',' ',' ','i','i','i','i',' ',' ',' ',' ',' ','c',' ','k'],#12
            ['k','s','e',' ',' ','i','h','k','i','i',' ',' ',' ','k','k','k',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','i','i','k'],#13
            ['k','s','s','w','w',' ','h',' ','k','k',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','i','k',' ','k'],#14
            ['k',' ','s','s',' ',' ','h',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','e',' ','i','k',' ',' ','k'],#15
            ['k',' ',' ',' ',' ',' ','h',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','i','i','i','k',' ',' ',' ','k'],#16
            ['k','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','l','k'],#17
...
while run:
    ...
    while game:
        ...
        if isPlayerHit:                                                                    # 
            ...
            player_y_vel = -9                                                              #
                                                                                           #  
            if playerKnockbackCounter <2:                                                  # making the player bounc back/take knockback when hit

...
#coins to collect
#coin counter
#coin display- for some reason this lags the game out, perhaps it is redwriting the amount of money every time. Will fix this to only update when a coin is grabbed, This has the problem of it will immediatly be redrawn over in black.
#perhaps i can redraw over everything but this area? Then i cant do the .fill method. Mabye it is best to only show the money counter at the end of the level

#New in this version
#draw all the counters at the top first, so that the player images ect will not be blocked by them
#added floating cloud platforms
import math 
import random
import pygame,sys
...
orbImage = pygame.image.load("Images/orbImage.png").convert_alpha()
outsideCloudImage = pygame.image.load("Images/outsideCloud.png").convert_alpha()
caveCloudImage = pygame.image.load("Images/caveCloud.png").convert_alpha()
cakeEnemy = pygame.image.load("Images/attackerEnemy.png").convert_alpha()
cakeEnemyHigh = pygame.image.load("Images/attackerEnemyHigh.png").convert_alpha()
cakeEnemyMedium = pygame.image.load("Images/attackerEnemyMedium.png").convert_alpha()
cakeEnemyLow = pygame.image.load("Images/attackerEnemyLow.png").convert_alpha()
cakeAttackerImages = [cakeEnemy,cakeEnemyHigh,cakeEnemyMedium,cakeEnemyLow]
levelPreviewImageFiller =pygame.image.load("Images/levelPreviewImageFiller.png").convert_alpha()
bombImage = pygame.image.load("Images/bombImage.png").convert_alpha()
levelSelectBg = pygame.image.load("Images/levelSelectBg.png").convert_alpha()  
healthbar = pygame.image.load("Images/healthbar.png").convert_alpha()
ammoCounterImage = pygame.image.load("Images/ammoCounter.png").convert_alpha()
timesSymbolImage = pygame.image.load("Images/timesSymbol.png").convert_alpha()
slashSymbolImage = pygame.image.load("Images/slashSymbol.png").convert_alpha()
image0 = pygame.image.load("Images/image0.png").convert_alpha()
image1 = pygame.image.load("Images/image1.png").convert_alpha()
image2 = pygame.image.load("Images/image2.png").convert_alpha()
image3 = pygame.image.load("Images/image3.png").convert_alpha()
image4 = pygame.image.load("Images/image4.png").convert_alpha()
image5 = pygame.image.load("Images/image5.png").convert_alpha()
numbers0to5 = [image0,image1,image2,image3,image4,image5]
crystalImage = pygame.image.load("Images/crystal.png").convert_alpha()
dirt = pygame.image.load("Images/dirtRectangle.png").convert_alpha()
grass = pygame.image.load("Images/grassRectangle.png").convert_alpha()
cobble = pygame.image.load("Images/cobbleRectangle.png").convert_alpha()
grassCobble = pygame.image.load("Images/grassyCobbleRectangle.png").convert_alpha()
lavaSurface = pygame.image.load("Images/lavaRectangleSurface.png").convert_alpha()
lava = pygame.image.load("Images/lavaRectangle.png").convert_alpha()
ammoCrateImage = pygame.image.load("Images/ammoCrate.png").convert_alpha()
outsideBg = pygame.image.load("Images/outsideBg.png").convert_alpha()
splashScreenImg = pygame.image.load("Images/splash screen v2.png").convert_alpha()
ladderImage = pygame.image.load("Images/ladder.png").convert_alpha()
climbing1 = pygame.image.load("Images/climbing1.png").convert_alpha()
climbing2 = pygame.image.load("Images/climbing2.png").convert_alpha()
climbingImages = [climbing1,climbing2]
knightRight = pygame.image.load("Images/knightRight.png").convert_alpha()
knightLeft = pygame.image.load("Images/knightLeft.png").convert_alpha()
right1 = pygame.image.load("Images/runningRight1.png").convert_alpha()
right2 = pygame.image.load("Images/runningRight2.png").convert_alpha()
right3 = pygame.image.load("Images/runningRight3.png").convert_alpha()
left1 = pygame.image.load("Images/runningLeft1.png").convert_alpha()
left2 = pygame.image.load("Images/runningLeft2.png").convert_alpha()
left3 = pygame.image.load("Images/runningLeft3.png").convert_alpha()
crouchRight1 =pygame.image.load("Images/crouchRight1.png").convert_alpha()
crouchLeft1 = pygame.image.load("Images/crouchLeft1.png").convert_alpha()
crouchRight2 =pygame.image.load("Images/crouchRight2.png").convert_alpha()
crouchLeft2 = pygame.image.load("Images/crouchLeft2.png").convert_alpha()
crouchingRight =[crouchRight1,crouchRight2]
crouchingLeft =[crouchLeft1,crouchLeft2]
bigCoinImage = pygame.image.load("Images/bigCoinImage.png").convert_alpha()
coin1 = pygame.image.load("Images/coin1.png").convert_alpha()
coin2 = pygame.image.load("Images/coin2.png").convert_alpha()
...
class Enemy():
    def __init__(self,x,y,width,height,health,damage,category,movementx=3,movementy=0,facing=1,counter=0,fireCounter = 0):#default movement is 3 to the right
        self.x = x
        self.y = y
        self.width = width
        self.height = height
    ...
    def attack(self):
        if self.fireCounter == 0:
            orbs.append(Orb(15,enemy.x,enemy.y,player_rect,100,10,orbImage))
            print("orb created")
            self.fireCounter += 1
        if self.fireCounter >10:
            self.fireCounter = 0 

class Orb():
    def __init__(self,length,enemyx,enemyy,player_rect,damage,vel,image,collisionTile = " ", collisionPlayer= " "):
        self.damage = damage
        self.image = image
        self.length = length
        self.collisionTile = collisionTile
        self.collisionPlayer = collisionPlayer
        self.x = enemyx
        self.y = enemyy

        self.vel = vel
        self.deltax =  (player_rect[0] + (player_rect[2]//2)) - enemyx
        self.deltay =  (player_rect[1] + (player_rect[3]//2)) - enemyy
        self.displacement = abs((self.deltax**2+self.deltay**2)**0.5)
        self.velx = (self.deltax/self.displacement)*self.vel
        self.vely = (self.deltax/self.displacement)*self.vel
...
class Bomb():
    def __init__(self,length,player_rect,damage,velx,vely,image,gravity=0.1,collisionTile = " ",collisionEnemy=" "):
        self.damage = damage
...
while run:
    ...
    while game:
        ...
        for row in game_map:                                                                                                                         
            ...
            for tile in row:
                if tile == "o":
                    win.blit(outsideCloudImage,((x-1) * TILE_SIZEX, y * TILE_SIZEY))
                if tile == "p":
                    win.blit(caveCloudImage,((x-1) * TILE_SIZEX, y * TILE_SIZEY))
                if tile == "w":                                                                             
                ...
                if tile == "c":
                    ...
                    if oneTimeLevelConstructor:
                        ...
                        totalCrystals +=1
                if tile == "a":
                    win.blit(ammoCrateImage,((x-1)*TILE_SIZEX, y*TILE_SIZEY+4))#the plus four makes images align better
                    if oneTimeLevelConstructor:
                ...
                if tile == "m" :                                                                               
                    ...
                    if oneTimeLevelConstructor:                                                                
                        coins.append(pygame.Rect((x-1)*TILE_SIZEX, y*TILE_SIZEY, TILE_SIZEX, TILE_SIZEY))                                                      
                if tile == "l":                                                                                              
                ...
                if tile =="e":
                    if oneTimeLevelConstructor:
                        enemies.append(Enemy(x*TILE_SIZEX, y*TILE_SIZEY,54,45,400,10,"attacker",2,0,1))
                if tile == "r":
                    if oneTimeLevelConstructor:
                        enemies.append(Enemy(x*TILE_SIZEX-32, y*TILE_SIZEY+9,54,45,400,10,"ranged",2,0,1))
                if tile not in bombCantHitList:      #the list of blocks for the projectiles to be able to hit(dont want hitting air or ladders)
                ...
                if tile == "o" or tile == "p":
                    tile_rects.append(pygame.Rect((x-1) * TILE_SIZEX, y * TILE_SIZEY, TILE_SIZEX, TILE_SIZEY))#need two blocks as clouds are twice as wide
        ...
        if  len(bombs)<4 and shotsFiredCounter == 0 and playerAmmo>0 and aimed :                        #
            bombs.append(Bomb(15,player_rect,99,aimVectorDeltax,aimVectorDeltay,bombImage)) #
            playerAmmo-=1                                                                               #
        ...
        for bomb in bombs:                                                                                    #
            bomb.move()                                                                                       #
            bomb.draw()                                                                                       # making projectiles do damage
            isCollidedTile,isCollidedEnemy, tileCollided, enemyCollided = bomb.collisionCheck(allBlocks)      # deleting projectiles when they hit things
            if isCollidedTile:                                                                                # making projectiles break blocks 
                if not(tileCollided[1] in cantCollideList):                                                   #                     
                    game_map[(tileCollided[0][1]//TILE_SIZEY)][(tileCollided[0][0]//TILE_SIZEX +1)] = " "     # 
                                                                                                              #
            if isCollidedEnemy:                                                                               #
                enemyCollided.health -= bomb.damage                                                           # 
            if isCollidedEnemy or isCollidedTile:                                                             #
                bombs.pop(bombs.index(bomb))                                                                  # must delete in the same place otherwise if bullet hits tile and enemy, will try to delete bullet twice otherwise

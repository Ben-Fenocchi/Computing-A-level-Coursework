...
class Enemy():
    ...
    def draw(self):
        ...
        win.blit(cakeEnemy,(self.rect[0],self.rect[1]))
    def move(self):
    ...
    while game:
        ...
        for row in game_map:                                                                                   #                                        
            ...
            for tile in row:                                                                                   #
                ...
                if tile =="e":
                    if oneTimeLevelConstructor:
                        enemies.append(Enemy((x-1)*TILE_SIZEX, y*TILE_SIZEY,54,45,100,10,"attacker",2,0,1))

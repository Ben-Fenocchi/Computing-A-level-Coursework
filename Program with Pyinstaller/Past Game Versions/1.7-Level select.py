#new in this version
#We have level select,Screen previewing all the levels, click on the one you want,
#Now moves onto the next level automatically,resets all values
#new p button to return you to menu so you can choose a different value
#each level is more different from the last, more customised as opposed to small differences so i could distinguish for coding purposes
import random
import pygame,sys
